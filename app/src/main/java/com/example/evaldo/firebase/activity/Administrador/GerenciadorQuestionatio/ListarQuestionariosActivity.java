package com.example.evaldo.firebase.activity.Administrador.GerenciadorQuestionatio;
...
import com.example.evaldo.firebase.activity.Administrador.adapter.PerguntasResumidasBaseAdapter;
    ...
    private void inicializarEventosLista() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //System.out.println("Posição = " + position + " " + "ID = " + id + " perguntasQuestionario = " + perguntasQuestionario);
                //tvNomeQuestionario.setText(perguntasQuestionario.getNomeQuestionario());
                //tvAdministradorResponsavel.setText(perguntasQuestionario.getAdministradorResponsavel());

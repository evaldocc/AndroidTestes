...
public class ListarResultadosResumidasActivity2 extends AppCompatActivity {
    ...
    Context context = ListarResultadosResumidasActivity2.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_resultados_resumidos2);
    ...
    private void iniciarFirebasePerguntas() {
        ...
        referencePerguntas.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                questAdapter = new ResultadosResumidosRecyclerAdapter(questListResumidos, ListarResultadosResumidasActivity2.this);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ListarResultadosResumidasActivity2.this, "Erro no iniciarFirebasePerguntas", Toast.LENGTH_LONG).show();
            }
        });
    }
